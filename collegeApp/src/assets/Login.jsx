  ...
  return (
    <div className="flex h-screen bg-green-100">
      ...
      <div className="min-h-screen bg-gradient-to-b from-green-200 to-green-400 flex flex-col items-center justify-center p-4 w-full">
        <div className="bg-green-200/80 flex items-center flex-col backdrop-blur-lg rounded-2xl shadow-lg p-6 md:p-12 mt-14">
          <img src={logo} alt="CECT Portal" className="w-14 h-14 mb-4 mx-auto" />
