...
const Approval = ({ user }) => {
  ...
  const handleCourseSelection = (e) => {
    ...
    if (selectedCourse) {
      ...
      // Reset the fields if no matching course is found
      setCourseCode("");
      setDuration("0 Weeks");
      setCredits("0");
    }
      ...
      <div className="bg-green-200/80 backdrop-blur-lg rounded-2xl shadow-lg p-4 sm:p-6 md:p-8 lg:p-12 mt-14 w-full max-w-4xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6 md:space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2 sm:gap-4 md:gap-6">
            <div className="col-span-1">
              <label className="block text-sm sm:text-base md:text-lg font-semibold mb-2" htmlFor="courseCode">
                <FaCheckCircle className="inline-block mr-2 text-green-500"/> Code:<span className="text-red-500">*</span>
              </label>
              <input 
                id="courseCode"
                required 
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2 sm:gap-4 md:gap-6">
            ...
            <div className="col-span-1">
              <label className="block text-sm sm:text-base md:text-lg font-semibold mb-2" htmlFor="assessmentMethod">
                <FaCheckCircle className="inline-block mr-2 text-green-500"/> Assessment Method:<span className="text-red-500">*</span>
              </label>
              <select
                id="assessmentMethod"
                className="border-2 border-gray-300 rounded-lg p-2 sm:p-3 w-full focus:outline-none focus:ring-2 focus:ring-green-500 transition duration-200"
                ...
                required
              >
                <option value="" disabled hidden>Select Assessment Method</option>
