...
const Head = ({ role }) => {
  ...
  <div className="flex flex-col text-center">
    <div className="text-lg md:text-2xl font-bold tracking-wide ml-96">CECT PORTAL</div>
    <div className="text-xs md:text-sm italic ml-96">Credit Equivalence and Credit Transfer</div>
  </div>
