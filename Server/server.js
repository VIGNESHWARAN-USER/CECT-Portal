...
app.post('/approval', async (req, res) => {
  const { name, roll, sec, year, dept, Email, courseTitle, courseCode, offeredBy, modeOfStudy, duration, credits, assessmentMethod } = req.body;
...
app.post('/drop', async (req, res) => {
  const { name, sec, year, dept, Email, courseName, courseCode, semester, category, credits} = req.body;
  const status = "Pending";
  const type = "Drop";
  const ca="no";
  const hod="no";
